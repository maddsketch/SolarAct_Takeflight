# Generates HullProceduralUnlit.shadergraph — run after editing, or use as reference.
import json
import uuid
...
OUT_PATH = __file__.replace("_build_hull_sg.py", "HullProceduralUnlit.shadergraph")
...
parts.append({
    ...
    "m_ObjectId": n_cf,
    "m_Group": {"m_Id": ""},
    "m_Name": "HullProceduralUnlit (Custom Function)",
    "m_DrawState": {"m_Expanded": True, "m_Position": {"serializedVersion": "2", "x": -200, "y": 60, "width": 300, "height": 260}},
    ...
    "m_CustomColors": {"m_SerializableColors": []},
    "m_SourceType": 0,
    "m_FunctionName": "HullProceduralUnlit",
